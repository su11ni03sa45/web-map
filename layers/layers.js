...
lyr_GoogleSatellite_0.setVisible(true);lyr_village_1.setVisible(true);lyr_water_way_2.setVisible(true);lyr_amphoe_3.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_village_1,lyr_water_way_2,lyr_amphoe_3];
lyr_village_1.set('fieldAliases', {'NRD_CODE': 'NRD_CODE', 'VILL_CODE': 'VILL_CODE', 'VILL_NAM_T': 'VILL_NAM_T', 'PROV_CODE': 'PROV_CODE', });
...
lyr_village_1.set('fieldImages', {'NRD_CODE': 'TextEdit', 'VILL_CODE': 'TextEdit', 'VILL_NAM_T': 'TextEdit', 'PROV_CODE': 'TextEdit', });
...
lyr_village_1.set('fieldLabels', {'NRD_CODE': 'no label', 'VILL_CODE': 'no label', 'VILL_NAM_T': 'no label', 'PROV_CODE': 'no label', });
...
lyr_amphoe_3.on('precompose', function(evt) {
